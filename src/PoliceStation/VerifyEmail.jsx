...
export default function VerifyEmail() {
  ...
  const handleVerifyEmail = async () => {
    ...
    // API integration
    const verifyEmailEndpoint = "http://localhost:4000/api/v1/forgotpasswordpolice"; // Replace with your actual API endpoint
        ...
        <main className="mx-10 mt-10 flex flex-wrap justify-center">
          <div className="p-6 bg-white text-gray-700 border rounded flex flex-wrap flex-col w-96">
            ...
            <div className='text-right mt-0 mb-2'>
                <p className='font-semibold text-sm text-orange-400 hover:text-orange-600   cursor-pointer '>Already verified?</p>
            </div>
