...
export default function Loginpolice() {
  ...
  const  handleLogin = async() => {
    ...
    // API integration
    const loginEndpoint = "http://localhost:4000/api/v1/policelogin"; // Replace with your actual API endpoint
...
<a href="/forgot-password" className="text-orange-400 font-semibold mt-2 hover:underline">
      Forgot Password?
    </a>
</div>
